<template>
  <div style="margin-left: auto">
    <b-button v-b-modal.modal-1 variant="success" style="width: 25%"
      >Escribir Reseña</b-button
    >
    <b-modal
      id="modal-1"
    ...
    >
      <template #modal-header="{ close }">
        <h5 style="color: #ae0505; justify-content: center; font-size: 2rem">
          Reseña
        </h5>
      ...
      <form id="form" @submit.prevent="checkForm">
        ...
        <div class="fieldContainer">
          <div class="textArea">
            <label for="name" style="font-weight: bold; color: #ae0505"
              >Deja tu reseña
            </label>
          </div>
          ...
          <div class="textArea">
            <label for="name" style="font-weight: bold; color: #ae0505"
              >¿Cómo calificarías el servicio?</label
            >
          </div>
          <div class="inputContainer">
            <b-form-rating
