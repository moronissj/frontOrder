...
export default {
  ...
  data() {
    return {
      ...
      items: [
        { id: 1, nombre: 'Fred', creacion: '23/03/2024', lugar:'comida', aprobado: false },
        { id: 2, nombre: 'Wilma', creacion: '23/03/2024', lugar:'comida', aprobado: false },
        { id: 3, nombre: 'Barney', creacion: '23/03/2024', lugar:'comida', aprobado: false },
      ]
    };
  },
  computed: {
